              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
					...
					echo form_open_multipart('/admin/editSlider', $attributes);?>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="slider_img" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="slider_img" type="file">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="editor" required="required" name="slider_desc" class="form-control col-md-7 col-xs-12" ><?php echo $desc; ?></textarea>
                        </div>
                      </div>
