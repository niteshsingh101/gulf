              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
					...
					echo form_open_multipart('/admin/editSalescontent', $attributes);?>

                      <span class="section">Sales Content Info</span>
					  <input type="hidden" name="action" value="editSalescontent">
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<?php 
						$query= $this->db->query("select * from sales_subcategory where parent_id=$parent_id");
						$row=$query->row_array();
						?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="content_title" class="form-control col-md-7 col-xs-12" name="content_title" placeholder="both name(s) e.g Jon Doe" 
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="content_img" class="form-control col-md-7 col-xs-12" name="content_img" type="file">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="editor" name="content_desc" class="form-control col-md-7 col-xs-12"><?php echo $desc; ?></textarea>
                        </div>
                      </div>
