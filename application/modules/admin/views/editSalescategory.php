              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
					...
					<input type="button" class="btn btn-success" onclick="location.href='<?php echo site_url();?>admin/salesCategoryList/'" value="Back" />
					<?php $attributes = array('class' => 'form-horizontal form-label-left', 'id' => 'myform');
					echo form_open_multipart('/admin/editSalescategory', $attributes);?>

                      <span class="section">Category Info</span>
						<input type="hidden" name="action" value="editSalescategory">
